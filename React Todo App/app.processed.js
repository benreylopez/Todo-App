...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _note = __webpack_require__(328);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      var notes = this.state.notes.map(function (val, key) {
	        return React.createElement(_note2.default, { key: key, text: val,
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'btn', onClick: this.addNote.bind(this) },
	          '+'
	        ),
	...
	var Note = function (_React$Component) {
	  ...
	  _createClass(Note, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { className: "note", onClick: this.props.deleteMethod },
	        this.props.text
	      );
	    }
	  }]);
